class Piece { //<>//
  ...
  Piece(char type) {
    ...
    switch(type) {
       ...
       */
    case 'L': 
      a = new Block(255, 165, 0);
      blocks.add(a);
      b = new Block(255, 165, 0);
      blocks.add(b);
      a.downBlock = b;
      b.upBlock = a;
      c = new Block(255, 165, 0);
      blocks.add(c);
      bottomBlocks.add(c);
      b.downBlock = c;
      c.upBlock = b;
      d = new Block(255, 165, 0);
      blocks.add(d);
      bottomBlocks.add(d);
      c.rightBlock = d;
      d.leftBlock = c;
    ...
    case 'I': 
       ...
       */
    case 'O': 
      a = new Block(255, 255, 0);
      blocks.add(a);
      b = new Block(255, 255, 0);
      blocks.add(b);
      bottomBlocks.add(b);
      a.downBlock = b;
      b.upBlock = a;
      c = new Block(255, 255, 0);
      blocks.add(c);
      bottomBlocks.add(c);
      c.leftBlock = b;
      b.rightBlock = c;
      d = new Block(255, 255, 0);
      blocks.add(d);
      bottomBlocks.add(d);
      d.downBlock = c;
      c.upBlock = d;
    ...
    case 'S': 
       ...
       */
    case 'T': 
      a = new Block(128, 0, 128);
      b = new Block(128, 0, 128);
      c = new Block(128, 0, 128);
      d = new Block(128, 0, 128);
      blocks.add(a);
      blocks.add(b);
      blocks.add(c);
      blocks.add(d);
